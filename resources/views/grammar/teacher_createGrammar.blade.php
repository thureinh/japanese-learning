		...
		<section>
			...
			<div class="container">
				<div class="row">
					...
					<form id="myForm" class="edited-form" method="POST" action="{{ route('grammar.store') }}" enctype="multipart/form-data">
      				@csrf
      					<div class="row">
      						<div class="col-12">
      							<div class="group">
								  <input  id="grammar_topic" type="text" name="grammar_topic" required autocomplete="off" value="{{ old('grammar_topic') }}" autofocus>
						...
						<div class="row my-3">
								<div id="canvas-editor" class="mx-auto"></div>
						</div>
						<div id="editor"></div>
						<div class="row">
							<div class="col-12">
								<button type="submit" class="btn btn-add w-100 py-2 my-4">Add Grammar</button>
							</div>
						</div>
...
@section('js')
	...
	<script type="text/javascript">var img_url = "{{asset('assets/img/white.png')}}"</script>
